        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                      <a href="<?= base_url()?>Blog/nueva">Nueva entrada</a>
                        
                    </li>
                    <li>
                       <a href="<?= base_url()?>Blog/entradas">Ver Entradas</a>
                    </li>
              
                
                 
                  </li>
                     <li style="color:#000; text-shadow: 1px 4px 4px #FFFFFF;background: rgba(249, 249, 255, 0.33) none repeat scroll 0% 0%;">Bienvenido <?php echo $username; ?>
                       
                     </li>
                      <a style="color:#fff; text-shadow: 4px 4px 4px #000;" href="/Blog_actualizado/blog/logout">Logout</a>
                     </div>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
